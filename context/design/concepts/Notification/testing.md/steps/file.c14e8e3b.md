...
content_id: c14e8e3bb7b2d14444ee1ce0a018e15a6aa44c3de7be93caae2cc51940e56438
---
...
export default class NotificationConcept {
  ...
  async createNotificationConfig(
    ...
    if (!owner || !email || !targetItem || !notificationType || dailyTime === undefined || emailSubjectTemplate === undefined || emailBodyTemplate === undefined || isEnabled === undefined) {
    ...
    if (!/^(?:2[0-3]|[01]?[0-9]):(?:[0-5]?[0-9])$/.test(dailyTime)) {
        return { error: "Invalid dailyTime format. Expected HH:MM (e.g., '09:00')." };
    }
  ...
  async editNotificationConfig(
    ...
    // Basic validation for required fields
    if (!settingID || !email || !targetItem || !notificationType || dailyTime === undefined || emailSubjectTemplate === undefined || emailBodyTemplate === undefined || isEnabled === undefined) {
