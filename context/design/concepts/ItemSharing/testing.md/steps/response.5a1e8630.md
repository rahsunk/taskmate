---
timestamp: 'Sun Oct 19 2025 18:23:29 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251019_182329.2e092db4.md]]'
content_id: 5a1e8630dfe307d5f5e14d89097ad0b567711ed5272e3d31904cf234b976f058
---
...
const EXTERNAL_ITEM_6 = createDummyId("item");
...
Deno.test("ItemSharing Concept Tests", async (t) => {
  ...
  await t.step("requestChange: error if requester not an accepted participant", async () => {
    ...
    const sharedItemResult = await itemSharing.makeItemShareable({ owner: USER_OWNER, externalItemID: EXTERNAL_ITEM_6 });
  ...
  await t.step("confirmChange / rejectChange: error cases", async () => {
    ...
    const sharedItemResult = await itemSharing.makeItemShareable({ owner: USER_OWNER, externalItemID: EXTERNAL_ITEM_1 + "unique" });
