...
content_id: e396d97cc9f4e6392631c530da5c424fe8e830733596bb79621b9b6f7afc6558
---

# file: src/ScheduleGenerator/ScheduleGeneratorConcept.ts

*(This file is reproduced as it was provided, as its TypeScript syntax is already correct and implements the intent of the corrected specification.)*
        ...
        if (shouldSchedule) {
          ...
          if (scheduledEventStartTime < scheduledEventEndTime && scheduledEventEndTime > new Date()) {
            generatedPlan.push({
              ...
              name: event.name,
              scheduledStartTime: scheduledEventStartTime, // FIX: Explicitly assign property
              scheduledEndTime: scheduledEventEndTime,     // FIX: Explicitly assign property
            });
