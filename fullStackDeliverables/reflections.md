...
- Made the Change Password blue if passwords match, gray otherwise like with the register button
- Made the time and day columns in schedule align properly (by setting the height of them to be equal)
- Added bottom margin to profile page to match the existing top margin
